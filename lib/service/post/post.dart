...
class Post {
  ...
  Future<SPBU_API> getSpbu(double lng, double lat, String token) async {
    var data = await http.get(
        "http://maxiaga.com/backend/api/get_spbu?lng=${lng}&lat=${lat}&token=$token");
  ...
  Future postOrder(Position currentLocation) async {
    ...
    var res =
        await http.post('http://maxiaga.com/backend/api/post_order', body: {
  ...
  Future postOrderBan(int id, String token, double lng, double lat) async {
